...
const UserAppointments = () => {
   ...
   }, []); // Empty dependency array ensures getUser is only created once
   ...
   }, [type, getDoctorAppointment, getUserAppointment]); // Added dependencies
                           ...
                           <tr key={appointment._id}>
                              ...
                              <td>
                                 {appointment.status === 'approved' ? (
                                    ...
                                    <Button onClick={() => handleStatus(appointment.userInfo._id, appointment._id, 'approved')}>Approve</Button>
                                 )}
                              </td>
                           </tr>
                        ))
